...
class RotatingKVCache(_BaseCache):
    ...
    def to_quantized(self, group_size: int = 64, bits: int = 4):
        # Gracefully bypass quantization for sliding window buffers to prevent NotImplemented crashes
        # since rotating caches are physically bounded and cannot cause Out Of Memory sequences.
        return self
