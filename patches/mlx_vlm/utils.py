...
def load_processor(
    ...
    try:
        ...
        if "Unrecognized processing class" in str(e) or "Can't instantiate" in str(e):
            import logging
            from transformers import AutoTokenizer
            logging.warning("AutoProcessor failed due to missing processing classes. Falling back to AutoTokenizer (Text Only)!")
